...
export default function ManageJobs() {
  ...
  if (selectedView === 'applications' && selectedJobId) {
    return <JobApplications jobId={selectedJobId} onBack={handleBackToList} />;
  }

  if (selectedView === 'edit' && selectedJobId) {
    return <EditJob jobId={selectedJobId} onBack={handleBackToList} onSave={handleSaveJob} />;
  }
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-4 gap-4">
                      <div className="bg-blue-50 rounded-lg p-3">
                        ...
                        <div className="text-xl font-bold text-blue-900">{job.applicants}</div>
                      </div>
