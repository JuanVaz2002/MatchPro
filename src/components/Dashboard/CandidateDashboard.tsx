  ...
  const jobRecommendations = [
    {
      ...
      salary: '$110k - $140k',
      matchScore: 95,
      reasons: ['React expertise', 'Location match', 'Salary preference']
    },
    {
      id: '2',
      ...
      salary: '$95k - $125k',
      matchScore: 89,
      reasons: ['JavaScript skills', 'Remote work', 'Experience level']
    }
  ];
                    ...
                    <div key={application.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <p className="text-gray-500 text-xs mt-1">Applied {application.appliedAt}</p>
                        </div>
